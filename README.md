...
### Example Protest Case
Below is an example of the pricing data and property value protest case generated by the `comp_investigator` tool:

![Pricing Data & Property Value Protest Example](assets/output.png)
